...
if __name__ == "__main__":
    ...
    def choose_nonword_random_with_objective_with_category(list_of_score_dict, word_nonword_dict, category_dict=None):
        """
        Main function of the algorithm described above. Also balance within the categories of the words if given, for ex:
            { the : highfreq,
              boy : highfreq,
              arc : lowfreq,
              ...}
